        ...
        <section className="bg__personalized w-full h-full flex flex-col justify-center items-center">
            <div className="w-full md:w-1/2 p-4 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col border__personalized p-4">
                    <h1 className="text-3xl font-bold text-zinc-900 text-center mb-3">Create a Listing</h1>
                    ...
                    <button
                        ...
                        className="py-2 px-3 rounded-md mt-3 bg-primary-200 transition duration-200 ease-in-out hover:shadow-lg text-white font-bold text-lg">{loading ? 'Creating...' : 'Create Listing'}</button>
